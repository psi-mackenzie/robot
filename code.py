...
async def main():
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, -440, 0, velocity=360) # Voltar até o primeiro poluente
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, -330, 0, velocity=360) # Ir para trás até +/- o centro
    ...
    print(angle())
    await turn(angle() * -1 + (45 - angle() * -1))                                                            # Girar 45 graus para direita
    ...
    await turn(45)                                                            # Girar 45 graus para direita
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 105, 0, velocity=360)# Ir mediamente para frente
    await turn(angle() * -1)                                                            # Girar 45 graus para direita
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 605, 0, velocity=360) # Ir mediamente para frente
    await motor.run_for_degrees(port.D, 528, 360)
